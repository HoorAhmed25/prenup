...
$result = $conn->query("SELECT governorate,sum(case when hb >= 13 then 1 else 0 end) as totalnormal,sum(case when hb >= 12 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when hb >= 13 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when hb between 11 and 13 then 1 else 0 end) as totalrisk,sum(case when hb between 11 and 12 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when hb between 11 and 13 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when hb between 8 and 11 then 1 else 0 end) as totalanemia,sum(case when hb between 8 and 11 and gender = 'أنثى' then 1 else 0 end) as Femaleanemia,sum(case when hb between 8 and 11 and gender = 'ذكر' then 1 else 0 end) as Maleanemia,sum(case when hb <  8 then 1 else 0 end) as totalvery,sum(case when hb < 8 and gender = 'أنثى' then 1 else 0 end) as Femalevery,sum(case when hb < 8 and gender = 'ذكر' then 1 else 0 end) as Malevery FROM users where governorate = '$governorate' and age between 18 and 30 GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
    elseif($stdate == '' && $endate == '' && $governorate != 'none' && $age == '2'){
$result = $conn->query("SELECT governorate,sum(case when hb >= 13 then 1 else 0 end) as totalnormal,sum(case when hb >= 12 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when hb >= 13 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when hb between 11 and 13 then 1 else 0 end) as totalrisk,sum(case when hb between 11 and 12 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when hb between 11 and 13 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when hb between 8 and 11 then 1 else 0 end) as totalanemia,sum(case when hb between 8 and 11 and gender = 'أنثى' then 1 else 0 end) as Femaleanemia,sum(case when hb between 8 and 11 and gender = 'ذكر' then 1 else 0 end) as Maleanemia,sum(case when hb <  8 then 1 else 0 end) as totalvery,sum(case when hb < 8 and gender = 'أنثى' then 1 else 0 end) as Femalevery,sum(case when hb < 8 and gender = 'ذكر' then 1 else 0 end) as Malevery FROM users where governorate = '$governorate' and age between 31 and 40 GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
                    elseif($stdate == '' && $endate == '' && $governorate != 'none' && $age == '3'){
$result = $conn->query("SELECT governorate,sum(case when hb >= 13 then 1 else 0 end) as totalnormal,sum(case when hb >= 12 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when hb >= 13 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when hb between 11 and 13 then 1 else 0 end) as totalrisk,sum(case when hb between 11 and 12 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when hb between 11 and 13 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when hb between 8 and 11 then 1 else 0 end) as totalanemia,sum(case when hb between 8 and 11 and gender = 'أنثى' then 1 else 0 end) as Femaleanemia,sum(case when hb between 8 and 11 and gender = 'ذكر' then 1 else 0 end) as Maleanemia,sum(case when hb <  8 then 1 else 0 end) as totalvery,sum(case when hb < 8 and gender = 'أنثى' then 1 else 0 end) as Femalevery,sum(case when hb < 8 and gender = 'ذكر' then 1 else 0 end) as Malevery FROM users where governorate = '$governorate' and age > 40 GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
                elseif($stdate == '' && $endate == '' && $governorate == 'none' && $age == '1'){
$result = $conn->query("SELECT governorate,sum(case when hb >= 13 then 1 else 0 end) as totalnormal,sum(case when hb >= 12 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when hb >= 13 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when hb between 11 and 13 then 1 else 0 end) as totalrisk,sum(case when hb between 11 and 12 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when hb between 11 and 13 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when hb between 8 and 11 then 1 else 0 end) as totalanemia,sum(case when hb between 8 and 11 and gender = 'أنثى' then 1 else 0 end) as Femaleanemia,sum(case when hb between 8 and 11 and gender = 'ذكر' then 1 else 0 end) as Maleanemia,sum(case when hb <  8 then 1 else 0 end) as totalvery,sum(case when hb < 8 and gender = 'أنثى' then 1 else 0 end) as Femalevery,sum(case when hb < 8 and gender = 'ذكر' then 1 else 0 end) as Malevery FROM users where age between 18 and 30 GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
                elseif($stdate == '' && $endate == '' && $governorate == 'none' && $age == '2'){
$result = $conn->query("SELECT governorate,sum(case when hb >= 13 then 1 else 0 end) as totalnormal,sum(case when hb >= 12 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when hb >= 13 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when hb between 11 and 13 then 1 else 0 end) as totalrisk,sum(case when hb between 11 and 12 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when hb between 11 and 13 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when hb between 8 and 11 then 1 else 0 end) as totalanemia,sum(case when hb between 8 and 11 and gender = 'أنثى' then 1 else 0 end) as Femaleanemia,sum(case when hb between 8 and 11 and gender = 'ذكر' then 1 else 0 end) as Maleanemia,sum(case when hb <  8 then 1 else 0 end) as totalvery,sum(case when hb < 8 and gender = 'أنثى' then 1 else 0 end) as Femalevery,sum(case when hb < 8 and gender = 'ذكر' then 1 else 0 end) as Malevery FROM users where age between 31 and 40 GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
                 elseif($stdate == '' && $endate == '' && $governorate == 'none' && $age == '3'){
$result = $conn->query("SELECT governorate,sum(case when hb >= 13 then 1 else 0 end) as totalnormal,sum(case when hb >= 12 and gender = 'أنثى' then 1 else 0 end) as Femalenormal,sum(case when hb >= 13 and gender = 'ذكر' then 1 else 0 end) as Malenormal,sum(case when hb between 11 and 13 then 1 else 0 end) as totalrisk,sum(case when hb between 11 and 12 and gender = 'أنثى' then 1 else 0 end) as Femalerisk,sum(case when hb between 11 and 13 and gender = 'ذكر' then 1 else 0 end) as Malerisk,sum(case when hb between 8 and 11 then 1 else 0 end) as totalanemia,sum(case when hb between 8 and 11 and gender = 'أنثى' then 1 else 0 end) as Femaleanemia,sum(case when hb between 8 and 11 and gender = 'ذكر' then 1 else 0 end) as Maleanemia,sum(case when hb <  8 then 1 else 0 end) as totalvery,sum(case when hb < 8 and gender = 'أنثى' then 1 else 0 end) as Femalevery,sum(case when hb < 8 and gender = 'ذكر' then 1 else 0 end) as Malevery FROM users where age > 40 GROUP by governorate order by governorate LIMIT $start,$limit");
	$customers = $result->fetch_all(MYSQLI_ASSOC); 
        }
    else{
