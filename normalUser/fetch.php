...
if(isset($_GET['nationalId']) && !empty($_GET['nationalId'])){
    ...
    $url = 'https://www.nccvh.org.eg/api2/wedding-inq';
...
//$nid = $result['nid'];
//$msg = $result['msg'];
  if(strlen($response) == 68){
 $msg = "الرقم القومى غير مسجل فى لجنة الفيروسات الكبدية";
...
//echo $msg;
    ...
    if($count >0){
      ...
      <section class="container" id="result">
        <h4 class="container-fluid headOfPersonal mb-0 pb-0">البيانات الأساسية</h4>
...
<?php if($hcv == "مصاب بفيروس C"){ 
           
                        ?>
                         
                         <div class="form-check mr-3 mb-4 col-4  border-left " id="HCVDiv" style="border: thick solid red;">
                            <label class="form-check-label pt-2 ml-2">Anti-HCV :</label>
                            <input required type="radio" name="hcv" id="yesHcv" value="متفاعل" onchange="activeHcv();"  checked>
                              <label class="ml-3" for="yesHcv" style="color: red;" > متفاعل </label>
                            <input type="radio" name="hcv" id="noHcv" value="غير متفاعل"  onchange="activeHcv();">
                            <label for="noHcv" style="color: red;" >غير متفاعل</label>
                        </div>
       ...
       <?php }
        ?>
                          <?php if($hbv == "مصاب بفيروس B"){ 
            
                        ?> 
                      
                          <div class="form-check mb-4 col-4   border-right" id="HBSDiv" style="border: thick solid red;">
                            <label class="form-check-label  pt-2 pl-1">HBsAg <span class="mr-4 pr-3">:</span></label>
                            <input required type="radio" name="hbsag" id="yeshbsag" value="متفاعل" onchange="activeHbs();" checked>
                            <label class="ml-3" for="yeshbsag" style="color: red;"> متفاعل </label>
                            <input type="radio" name="hbsag" id="nohbsag" value="غير متفاعل" onchange="activeHbs();">
                            <label for="nohbsag" style="color: red;">غير متفاعل</label>
                        </div>
                          <?php }
        else{ 
                      ?>
 ...
 <?php }
        ?>
                    ...
                    <div class="row">
                        <?php if($hiv == "مصاب بفيروس نقص المناعة البشرية"){ ?> 
                      
<div class="form-check mr-3 mb-4 col-4  border-left " id="HIVDiv" style="border: thick solid red;">

                            <label class="form-check-label pt-2 pl-2">Anti-HIV <span class="mr-1">:</span></label>
                            <input required type="radio" name="hiv" id="yesHiv" value="متفاعل" onchange="activeHiv();" checked>
                            <label class="ml-3" for="yesHiv" style="color: red;"> متفاعل </label>
                            <input type="radio" name="hiv" id="noHiv" value="غير متفاعل" onchange="activeHiv();">
                            <label for="noHiv" style="color: red;">غير متفاعل</label>
                        </div>
                         <?php }
        else{ 
                      ?>
